...
public class JSIntArray extends JSArray {

	public JSIntArray(JSStatement jsStatement) {
		setParent(jsStatement.getParent());
		
		System.out.println("INTARRAY:"+jsStatement);
	...
	public String getType() {
		return "int"+StringUtils.repeat("[]", getDimension());
	}
